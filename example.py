#!/usr/bin/env python
# rename to bytecoin-bcn.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/bytecoin-bcn/")
...
print("bytecoin-bcn $" + str(usd) + " | iconName=invest-applet")
print("---")
