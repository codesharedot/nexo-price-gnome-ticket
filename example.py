#!/usr/bin/env python
# rename to v-systems.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/v-systems/")
...
print("v-systems $" + str(usd) + " | iconName=invest-applet")
print("---")
