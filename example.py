#!/usr/bin/env python
# rename to crypto-com.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/crypto-com/")
...
print("crypto-com $" + str(usd) + " | iconName=invest-applet")
print("---")
