#!/usr/bin/env python
# rename to bitshares.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/bitshares/")
...
print("bitshares $" + str(usd) + " | iconName=invest-applet")
print("---")
