#!/usr/bin/env python
# rename to dogecoin.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/dogecoin/")
...
print("dogecoin $" + str(usd) + " | iconName=invest-applet")
print("---")
