#!/usr/bin/env python
# rename to abbc-coin.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/abbc-coin/")
...
print("abbc-coin $" + str(usd) + " | iconName=invest-applet")
print("---")
