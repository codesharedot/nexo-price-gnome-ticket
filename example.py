#!/usr/bin/env python
# rename to bitcoin-gold.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/bitcoin-gold/")
...
print("bitcoin-gold $" + str(usd) + " | iconName=invest-applet")
print("---")
