#!/usr/bin/env python
# rename to paxos-standard.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/paxos-standard/")
...
print("paxos-standard $" + str(usd) + " | iconName=invest-applet")
print("---")
