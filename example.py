#!/usr/bin/env python
# rename to bittorrent.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/bittorrent/")
...
print("bittorrent $" + str(usd) + " | iconName=invest-applet")
print("---")
