#!/usr/bin/env python
# rename to ardor.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/ardor/")
...
print("ardor $" + str(usd) + " | iconName=invest-applet")
print("---")
