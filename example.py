#!/usr/bin/env python
# rename to kucoin-shares.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/kucoin-shares/")
...
print("kucoin-shares $" + str(usd) + " | iconName=invest-applet")
print("---")
